<?php 
	...
	#Edit news
		...
		<form action="" id="news_form_edit" name="news_form_edit" method="POST" enctype="multipart/form-data">
			...
			<label for="archive">Arhivirati:</label><br /><br>
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img  class="favikon" width 10px;" src="img/edit.png" alt="uredi"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img  class="favikon" width 10px;" src="img/delete.png" alt="obriši"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
