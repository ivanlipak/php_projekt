<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		$query  = "UPDATE users SET firstname='" . $_POST['firstname'] . "', lastname='" . $_POST['lastname'] . "', email='" . $_POST['email'] . "', username='" . $_POST['username'] . "', country='" . $_POST['country']. "', role='" . $_POST['role'] . "', country='" . $_POST['country'] . "', archive='" . $_POST['archive'] . "'";
		...
		$_SESSION['message'] = '<p>Promijenili ste korisnika!</p>';
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td>';
						if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
							print '<a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img class="favikon" src="img/edit.png" alt="uredi"></a></td>';
						}
					print '
					<td>';
						if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
							print '<a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img class="favikon" src="img/delete.png" alt="obriši"></a>';
						}
					print '	
